...
install("twbs:bootstrap");                                                // 62
install("less");                                                          // 63
install("deps");                                                          // 64
install("htmljs");                                                        // 65
install("observe-sequence");                                              // 66
install("blaze");                                                         // 67
install("spacebars");                                                     // 68
install("templating");                                                    // 69
install("barbatus:stars-rating");                                         // 70
install("ddp-rate-limiter");                                              // 71
install("localstorage");                                                  // 72
install("callback-hook");                                                 // 73
install("accounts-base");                                                 // 74
install("service-configuration");                                         // 75
install("reactive-dict");                                                 // 76
install("session");                                                       // 77
install("npm-bcrypt");                                                    // 78
install("sha");                                                           // 79
install("srp");                                                           // 80
install("accounts-password");                                             // 81
install("accounts-ui-unstyled");                                          // 82
install("accounts-ui");                                                   // 83
install("webapp");                                                        // 84
install("livedata");                                                      // 85
